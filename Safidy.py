...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fanantenana','Fanantenana','nantenaina','Nantenaina','narovana','Narovana','fitiavana','Fitiavana','mirindra','Mirindra','maminirina','Maminirina','Mamako','Malala','malala','nilaina','malagasy','Malagasy','marary','Marary','fanasina','Fanasina','Nilaina','Nekena','nekena','mihary','Mihary','narovana','Narovana','riantsoa','Riantsoa','nirina','mamako','malala','vadiko','mamiko','fitiavana','safidy','mahefa','fanantenana','anjara','lahatra','nantenaina','Nantenaina','finoana','nilaina','fiderana','hasina','nomena','fandresena','lafatra','amboara','tantely','faniry','tolotra','fahendrena','malalako','Faniry','fitahina','Fanantenana','mahery','solofo','faneva','tafita','fiderana','Miangola','miangaly','Miangaly','Fiderana','Nilaina','Mahery','Lahatra','Nirina','Amboara','Lafatra','fandresena','Fandresena','narovana','Fanantenana','Nekena','Mamako','Fitiavana','Anjara','Malala','Safidy','Vadiko','Mahefa','randria','Randria','Fitahina','Faneva','Narovana','Solofo','ravaka','Ravaka','sarindra','narindra','fanomezana','Tafita','Fiderana','fandresena','Fandresena','Rakotomalala','rakotomalala']
