...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'mahery','vadiko','mamako','mamiko','malalako','tanjona','mahefa','fitiavana','fanantenana','nirina','anjara','nomena','papako','faniry','finoana','faneva','nilaina','hasina','fitahina','malala','mendrika','mandresy','safidy','fifalina','fitiavako','Mahefa','harena','fitahina','fahendrena','sarobidy','valisoa','miangaly','miangola','Valisoa','finoana','Finoana','namako','hasina','Hasina','malala','Malala','faniry','Faniry','fanantenana','Fanantenana','nekena','Nekena','fifalina','Fifalina','fitahina','Fitahina','faniry','Faniry','mandresy','Mandresy','fiderana','Fiderana','fandresena','Fandresena','Nilaina','nilaina','diamondra','Diamondra','fanomezana','Fanomezana','mendrika','Mendrika']
