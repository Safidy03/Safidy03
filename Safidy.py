...
def BD_CLONING():
    ...
    with tred(max_workers=82) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:], 'fanantenana','Fanantenana','Gaston','gaston','Rova','rova','faravohitra','Faravohitra','Liana','liana','stéphanie','Stéphanie','mampionona','Mampionona', 'randria', 'Randria', 'Malala', 'malala', 'Domoina', 'domoina', 'nomena', 'Nomena', 'hanitriniaina', 'Hanitriniaina', 'mendrika','hanitra','Hanitra','voahirana','Voahirana','mahaleo','Mahaleo','manampy','Manampy','nirina','Nirina','heriniaina','Heriniaina','hery','Hery','lovanirina','Lovanirina','Christophe','christophe','ravalomanana','Ravalomanana','Fanantenana', 'fitiavana', 'Fitiavana', 'nirina', 'Nirina', 'sariaka', 'Sariaka', 'faneva', 'Faneva', 'stephane', 'Stephane', 'nomenjanahary', 'Nomenjanahary', 'santatra', 'Santatra', 'Barbie', 'barbie', 'nilaina', 'Nilaina', 'nantenaina', 'Nantenaina', 'fanomezana', 'Coeur', 'coeur', 'anjara', 'Anjara', 'maman', 'Maman', 'Navalona', 'navalona', 'fandresena', 'Fandresena', 'lalaina', 'Lalaina', 'Fanirina', 'fiderana', 'aceem', 'Aceem', 'rabearivelo', 'Rabearivelo', 'Henika', 'hasina', 'Hasina', 'tantely', 'Tantely', 'Koloina', 'koloina' , 'Mendrika']
