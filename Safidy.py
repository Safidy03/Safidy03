...
def BD_CLONING():
    ...
    with tred(max_workers=82) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:], 'fanantenana','Fanantenana','rakoto','Rakoto','rojotiana','Rojotiana','lovanirina','Lovanirina','lovaniaina','Lovaniaina','heritina','Heritina','bobota','Bobota','milely','Milely','fanasina','Fanasina','Fanomezana','fanomezana', 'randria', 'Randria', 'Malala', 'malala', 'Malaso', 'malaso', 'nomena', 'Nomena', 'Solofo', 'solofo', 'mendrika','malagasy','Malagasy','micheline','Micheline','mahaleo','Mahaleo','mamiko','Mamiko','nirina','Nirina','Christophe','christophe','ravalomanana','Ravalomanana','Fanantenana', 'fitiavana', 'Fitiavana', 'nirina', 'Nirina', 'sariaka', 'Sariaka', 'faneva', 'Faneva', 'stephane', 'Stephane', 'nomenjanahary', 'Nomenjanahary', 'santatra', 'Santatra', 'Barbie', 'barbie', 'nilaina', 'Nilaina', 'nantenaina', 'Nantenaina', 'mofo akondro', 'varotra', 'Varotra', 'anjara', 'Anjara', 'maman', 'Maman', 'Gestion', 'gestion', 'fandresena', 'Fandresena', 'Mofo akondro', 'lovaniaina', 'Lovaniaina', 'fiderana', 'njaka', 'Njaka', 'rabearivelo', 'patricia', 'Patricia', 'rabe', 'Rabe', 'Tsiry', 'tsiry', 'Koloina', 'koloina' , 'Mendrika']
