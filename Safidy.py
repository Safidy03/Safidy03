...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','fanomezana','fanantenana','nirina','Fitiavana','miangaly','mendrika','Nirina','miangola','Miangaly','mahery','Mahery','Miangola','faneva','randria','Randria','safidy','Mendrika','Safidy','mahefa','Mahefa','nilaina','Nilaina','valisoa','finoana','fitiavako','rojotiana','tanjona','Tanjona','Fanantenana','Fanomezana','solofo','malala','Malala','mamako','Mamako','nekena','fahendrena','fiderana','fandresena','Nekena','nantenaina','Nantenaina','tolotra','Tolotra','jesosy','faneva','Jesosy','vadiko','Vadiko','anjara','Anjara','milely','narovana','Narovana','koloina','Koloina','mamisoa','Narindra','sarobidy','sarindra','malagasy','Malagasy','mamiko','mahefa','anjara','lahatra','finoana','fiderana','hasina','nomena','fandresena','lafatra','amboara','tantely','faniry','tolotra','fahendrena','fiderana','Fiderana','rakotomalala']
