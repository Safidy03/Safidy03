...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nirina','anjara','mamako','koloina','mahery','mihary','fitiavana','safidy','felana','mahefa','fitiavako','papako','tanjona','fifalina','malala','nomena','valisoa','faniry','ravaka','papako','malalako','vadiko','anjarako','finoana','jesosy','sitraka','santatra','herizo','lahatra','lafatra','nilaina','nomena','harena','finoana','diamondra','fanomezana','fanantenana','fifalina','harena','fitahina','fahendrena','sarobidy','valisoa','miangaly','miangola','Valisoa','finoana','Finoana','namako','hasina','Hasina','malala','Malala','faniry','Faniry','fanantenana','Fanantenana','nekena','Nekena','fifalina','Fifalina','fitahina','Fitahina','faniry','Faniry','mandresy','Mandresy','fiderana','Fiderana','fandresena']
