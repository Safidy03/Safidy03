...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nekena','Nekena','fitiavana','Fitiavana','miangola','nomena','amboara','Nomena','Amboara','Miangola','fiderana','Fiderana','miangaly','Miangaly','nilaina','Nilaina','mahery','Mahery','nirina','Nirina','mamisoa','Mamisoa','fandresena','Fandresena','fanantenana','Fanantenana','mamako','Mamako','anjara','Anjara','malala','Malala','safidy','Safidy','vadiko','Vadiko','mahefa','Mahefa','randria','Randria','faneva','Faneva','solofo','Solofo','ravaka','Ravaka','sarindra','narindra','fanomezana','fiderana','Fiderana','fandresena','Fandresena','nantenaina','Nantenaina','Rakotomalala','rakotomalala','fahendrena','Fahendrena','finoana','Finoana','Fanomezana','faneva','Faneva','valisoa','Valisoa','malalako','Malalako','narovana','Narovana','mamiko','Mamiko','tantely','Tantely','tolotra','Tolotra','fifaliana','Fifaliana','milely','Milely']
