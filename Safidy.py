...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'safidy','Safidy','nilaina','Nilaina','malala','Malala','malalako','Malalako','mamako','Mamako','fitiavana','Fitiavana','nekena','Nekena','fanantenana','Fanantenana','nirina','Nirina','nantenaina','Nantenaina','lafatra','Lafatra','Lahatra','lahatra','tolotra','Tolotra','jesosy','faneva','Jesosy','vadiko','Vadiko','anjara','Anjara','malala','Malala','narovana','Narovana','koloina','Koloina','fandresena','Fandresena','narindra','Narindra','sarobidy','sarindra','malagasy','Malagasy','mamiko','mahefa','anjara','finoana','fiderana','hasina','nomena','fandresena','amboara','tantely','faniry','fahendrena','Faniry','mahery','solofo','faneva','fiderana','Miangola','miangaly','Miangaly','Fiderana','Mahery','Lahatra','Amboara','Lafatra','Mahefa','randria','Randria','Faneva','Solofo','fanomezana','Rakotomalala','rakotomalala']
