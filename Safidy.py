...
def BD_CLONING():
    ...
    with tred(max_workers=82) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:], 'fanantenana','Fanantenana','lovasoa','Lovasoa','dadarabe','Dadarabe','bemaso','Bemaso','fanjakana','Fanjakana','stéphanie','Stéphanie','mampionona','Mampionona', 'randria', 'Randria', 'Malala', 'malala', 'Domoina', 'domoina', 'nomena', 'Nomena', 'Solofo', 'solofo', 'mendrika','ranomanitra','ranomanitra','Anja','anja','mahaleo','Mahaleo','mamiko','Mamiko','nirina','Nirina','heriniaina','Heriniaina','hery','Hery','lovanirina','Lovanirina','Christophe','christophe','ravalomanana','Ravalomanana','Fanantenana', 'fitiavana', 'Fitiavana', 'nirina', 'Nirina', 'sariaka', 'Sariaka', 'faneva', 'Faneva', 'stephane', 'Stephane', 'nomenjanahary', 'Nomenjanahary', 'santatra', 'Santatra', 'Barbie', 'barbie', 'nilaina', 'Nilaina', 'nantenaina', 'Nantenaina', 'mofo akondro', 'Coeur', 'coeur', 'anjara', 'Anjara', 'maman', 'Maman', 'Gestion', 'gestion', 'fandresena', 'Fandresena', 'Mofo akondro', 'ayam', 'Ayam', 'fiderana', 'njaka', 'Njaka', 'rabearivelo', 'agrad', 'Agrad', 'rabe', 'Rabe', 'Tsiry', 'tsiry', 'Koloina', 'koloina' , 'Mendrika']
