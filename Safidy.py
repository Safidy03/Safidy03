...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'papako','Papako','solofo','Solofo','rakoto','Rakoto','seheno','Seheno','felana','Felana','mahery','Mahery','fitiavana','Fitiavana','fanomezana','Fanomezana','safidiko','mahefa','Mahefa','fitiavako','tanjona','Tanjona','fifaliana','Fifaliana','malala','Malala','Malalako','malalako','valisoa','faniry','ravaka','papako','malalako','vadiko','anjarako','finoana','jesosy','sitraka','santatra','herizo','lahatra','lafatra','nilaina','nomena','harena','finoana','diamondra','fanomezana','fanantenana','fifalina','harena','fitahina','fahendrena','sarobidy','valisoa','miangaly','miangola','Valisoa','finoana','Finoana','namako','hasina','Hasina','malala','Malala','faniry','malagasy','Malagasy','Faniry','fanantenana','Fanantenana','nekena','Nekena','fifalina','Fifalina','fitahina','Fitahina','faniry','Faniry','mandresy','Mandresy','fiderana','Fiderana','Rajoelina','rajoelina','Fandresena','fandresena']
