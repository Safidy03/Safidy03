...
def BD_CLONING():
    ...
    with tred(max_workers=40) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'malala','Malala','fanasina','Fanasina','mendrika','Mendrika','malagasy','Malagasy','vadiko','Vadiko','miangola','Miangola','fiderana','Fiderana','narindra','Narindra','miangaly','Miangaly','fandresena','Fandresena','valisoa','Valisoa','nirina','Nirina','nomena','Nomena','nilaina','Nilaina','nambinina','Nambinina','faniry','Faniry','fitiavana','Fitiavana','rakoto','Rakoto','lahatra','Lahatra','lafatra','Lafatra']
